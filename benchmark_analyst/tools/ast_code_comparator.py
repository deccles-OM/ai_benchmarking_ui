...
if __name__ == "__main__":
    comp = ASTCodeComparator()
    
    # Test 1: Same logic, different formatting
    code1 = """
import pandas as pd
...
"""
    ...
    score, issues = comp.compare(code1, code2)
    print(f"Test 1 Score: {score:.2f}")
    if issues:
...
"""
    ...
    score, issues = comp.compare(code3, code4)
    print(f"Test 2 Score: {score:.2f}")
    if issues:
        print(f"Issues: {issues}")
